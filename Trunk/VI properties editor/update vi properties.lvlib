...
<Library LVVersion="13008000">
	...
	<Item Name="apply control changes.vi" Type="VI" URL="../apply control changes.vi"/>
	<Item Name="change all descriptions.vi" Type="VI" URL="../change all descriptions.vi"/>
	<Item Name="Event Data.ctl" Type="VI" URL="../Event Data.ctl"/>
	<Item Name="Update VI Properties.vi" Type="VI" URL="../Update VI Properties.vi"/>
	<Item Name="user action.ctl" Type="VI" URL="../user action.ctl"/>
</Library>
